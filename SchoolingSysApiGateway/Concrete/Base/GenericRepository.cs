    ...
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        public async Task Add(T entity)
        {
            try
            {
                ...
                //var savedEntity = this._unitOfWork.TeleHelpDeskTasksBoardDbContext.Set<T>().Add(entity);
        ...
        //        var savedEntity = this._unitOfWork.TeleHelpDeskTasksBoardDbContext.Set<T>().Remove(entity);
        ...
        //        var entityList = this._unitOfWork.TeleHelpDeskTasksBoardDbContext.Set<T>().ToList();
        ...
        //        var entity = this._unitOfWork.TeleHelpDeskTasksBoardDbContext.Set<T>().FirstOrDefault(predicate);
        ...
        //        var entityList = this._unitOfWork.TeleHelpDeskTasksBoardDbContext.Set<T>().Where(predicate).ToList();
        //        return await Task.FromResult(entityList);
        //    }
        //    catch (Exception ex)
        //    {
        ...
        //    //    var savedEntity = this._unitOfWork.TeleHelpDeskTasksBoardDbContext.Set<T>().Update(entity);
        //    //    await Task.FromResult(savedEntity.Entity);
        //    //}
        //    //catch (Exception ex)
        //    //{
        ...
        //    //    {
        //    //        this._unitOfWork.TeleHelpDeskTasksBoardDbContext.Set<T>().Add(entity);
        //    //    }
        ...
        //    //    foreach (var entity in entities)
        //    //    {
        //    //        this._unitOfWork.TeleHelpDeskTasksBoardDbContext.Set<T>().Remove(entity);
        //    //    }
        ...
        //    //    foreach (var entity in entities)
        //    //    {
        //    //        this._unitOfWork.TeleHelpDeskTasksBoardDbContext.Set<T>().Update(entity);
        //    //    }
